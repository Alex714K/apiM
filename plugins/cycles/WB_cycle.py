...
def WB_cycle():
    ...
    # grand
    schedule.every().day.at('04:10').do(API.start, 'orders_1mnth', 'grand', 'WB')
    schedule.every().day.at('04:15').do(API.start, 'orders_1week', 'grand', 'WB')
    schedule.every().day.at('04:20').do(API.start, 'orders_2days', 'grand', 'WB')
    schedule.every().day.at('04:25').do(API.start, 'sales_1mnth', 'grand', 'WB')
    schedule.every().day.at('04:30').do(API.start, 'tariffs_boxes', 'grand', 'WB')
    schedule.every().day.at('04:35').do(API.start, 'tariffs_pallet', 'grand', 'WB')

    # terehov
    schedule.every().day.at('04:40').do(API.start, 'orders_1mnth', 'terehov', 'WB')
    schedule.every().day.at('04:45').do(API.start, 'orders_1week', 'terehov', 'WB')
    schedule.every().day.at('04:50').do(API.start, 'orders_2days', 'terehov', 'WB')
    schedule.every().day.at('04:55').do(API.start, 'sales_1mnth', 'terehov', 'WB')
    schedule.every().day.at('05:00').do(API.start, 'tariffs_boxes', 'terehov', 'WB')
    schedule.every().day.at('05:05').do(API.start, 'tariffs_pallet', 'terehov', 'WB')

    # dnk
    schedule.every().day.at('05:10').do(API.start, 'orders_1mnth', 'dnk', 'WB')
    schedule.every().day.at('05:15').do(API.start, 'orders_1week', 'dnk', 'WB')
    schedule.every().day.at('05:20').do(API.start, 'orders_2days', 'dnk', 'WB')
    schedule.every().day.at('05:25').do(API.start, 'sales_1mnth', 'dnk', 'WB')
    schedule.every().day.at('05:30').do(API.start, 'tariffs_boxes', 'dnk', 'WB')
    schedule.every().day.at('05:35').do(API.start, 'tariffs_pallet', 'dnk', 'WB')

    # planeta
    schedule.every().day.at('05:40').do(API.start, 'orders_1mnth', 'planeta', 'WB')
    schedule.every().day.at('05:45').do(API.start, 'orders_1week', 'planeta', 'WB')
    schedule.every().day.at('05:50').do(API.start, 'orders_2days', 'planeta', 'WB')
    schedule.every().day.at('05:55').do(API.start, 'sales_1mnth', 'planeta', 'WB')
    schedule.every().day.at('06:00').do(API.start, 'tariffs_boxes', 'planeta', 'WB')
    schedule.every().day.at('06:05').do(API.start, 'tariffs_pallet', 'planeta', 'WB')

    # 2ruz
    schedule.every().day.at('06:10').do(API.start, 'orders_1mnth', '2ruz', 'WB')
    schedule.every().day.at('06:15').do(API.start, 'orders_1week', '2ruz', 'WB')
    schedule.every().day.at('06:20').do(API.start, 'orders_2days', '2ruz', 'WB')
    schedule.every().day.at('06:25').do(API.start, 'sales_1mnth', '2ruz', 'WB')
    schedule.every().day.at('06:30').do(API.start, 'tariffs_boxes', '2ruz', 'WB')
    schedule.every().day.at('06:35').do(API.start, 'tariffs_pallet', '2ruz', 'WB')

    # peco
    schedule.every().day.at('06:40').do(API.start, 'orders_1mnth', 'peco', 'WB')
    schedule.every().day.at('06:45').do(API.start, 'orders_1week', 'peco', 'WB')
    schedule.every().day.at('06:50').do(API.start, 'orders_2days', 'peco', 'WB')
    schedule.every().day.at('06:55').do(API.start, 'sales_1mnth', 'peco', 'WB')
    schedule.every().day.at('07:00').do(API.start, 'tariffs_boxes', 'peco', 'WB')
    schedule.every().day.at('07:05').do(API.start, 'tariffs_pallet', 'peco', 'WB')

    # rus_house
    schedule.every().day.at('07:10').do(API.start, 'orders_1mnth', 'rus_house', 'WB')
    schedule.every().day.at('07:15').do(API.start, 'orders_1week', 'rus_house', 'WB')
    schedule.every().day.at('07:20').do(API.start, 'orders_2days', 'rus_house', 'WB')
    schedule.every().day.at('07:25').do(API.start, 'sales_1mnth', 'rus_house', 'WB')
    schedule.every().day.at('07:30').do(API.start, 'tariffs_boxes', 'rus_house', 'WB')
    schedule.every().day.at('07:35').do(API.start, 'tariffs_pallet', 'rus_house', 'WB')
