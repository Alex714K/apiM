...
class Converter:
    ...
    def prices(self, file: list | dict):
        ...
        for row in file:
            ...
            values.append(row["marketing_actions"]["current_period_from"])
            values.append(row["marketing_actions"]["current_period_to"])
            values.append(row["marketing_actions"]["ozon_actions_exist"])
            ...
            values.append(row["price"]["min_price"])
            ...
            values.append(row["price_indexes"]["color_index"])
            if row["price_indexes"]["external_index_data"] is None:
                values.extend([None, None, None])
            else:
                values.append(row["price_indexes"]["external_index_data"]["min_price"])
                values.append(row["price_indexes"]["external_index_data"]["min_price_currency"])
                values.append(row["price_indexes"]["external_index_data"]["price_index_value"])

            if row["price_indexes"]["ozon_index_data"] is None:
                values.extend([None, None, None])
            else:
                values.append(row["price_indexes"]["ozon_index_data"]["min_price"])
                values.append(row["price_indexes"]["ozon_index_data"]["min_price_currency"])
            ...
            if row["price_indexes"]["self_marketplaces_index_data"] is None:
                ...
                values.append(row["price_indexes"]["self_marketplaces_index_data"]["min_price"])
                values.append(row["price_indexes"]["self_marketplaces_index_data"]["min_price_currency"])
